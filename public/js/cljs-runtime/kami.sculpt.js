...
var vec__21617 = new cljs.core.Keyword("brush","center","brush/center",-586838954).cljs$core$IFn$_invoke$arity$1(b);
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21617,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21617,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21617,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__21623_SHARP_){
return (p1__21623_SHARP_ * s);
}),v);
});
...
return kami.sculpt.sqrt(cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21625_SHARP_){
return (p1__21625_SHARP_ * p1__21625_SHARP_);
}),v)));
});
...
var positions = cljs.core.vec((function (){var iter__5480__auto__ = (function kami$sculpt$iter__21631(s__21632){
return (new cljs.core.LazySeq(null,(function (){
var s__21632__$1 = s__21632;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__21632__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var j = cljs.core.first(xs__6385__auto__);
var iterys__5476__auto__ = ((function (s__21632__$1,j,xs__6385__auto__,temp__5825__auto__){
return (function kami$sculpt$iter__21631_$_iter__21633(s__21634){
return (new cljs.core.LazySeq(null,((function (s__21632__$1,j,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__21634__$1 = s__21634;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__21634__$1);
if(temp__5825__auto____$1){
var s__21634__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__21634__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21634__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21636 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21635 = (0);
while(true){
if((i__21635 < size__5479__auto__)){
var i = cljs.core._nth(c__5478__auto__,i__21635);
var v = (j / stacks);
var u = (i / slices);
var phi = (kami.sculpt.pi * v);
var theta = (((2) * kami.sculpt.pi) * u);
cljs.core.chunk_append(b__21636,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [((radius * kami.sculpt.sin(phi)) * kami.sculpt.cos(theta)),(radius * kami.sculpt.cos(phi)),((radius * kami.sculpt.sin(phi)) * kami.sculpt.sin(theta))], null));

var G__21744 = (i__21635 + (1));
i__21635 = G__21744;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21636),kami$sculpt$iter__21631_$_iter__21633(cljs.core.chunk_rest(s__21634__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21636),null);
}
} else {
var i = cljs.core.first(s__21634__$2);
var v = (j / stacks);
var u = (i / slices);
var phi = (kami.sculpt.pi * v);
var theta = (((2) * kami.sculpt.pi) * u);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [((radius * kami.sculpt.sin(phi)) * kami.sculpt.cos(theta)),(radius * kami.sculpt.cos(phi)),((radius * kami.sculpt.sin(phi)) * kami.sculpt.sin(theta))], null),kami$sculpt$iter__21631_$_iter__21633(cljs.core.rest(s__21634__$2)));
}
} else {
return null;
}
...
});})(s__21632__$1,j,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__21632__$1,j,xs__6385__auto__,temp__5825__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1((slices + (1)))));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,kami$sculpt$iter__21631(cljs.core.rest(s__21632__$1)));
} else {
var G__21751 = cljs.core.rest(s__21632__$1);
s__21632__$1 = G__21751;
continue;
}
} else {
return null;
...
var cols = (slices + (1));
var indices = cljs.core.vec(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__21637){
var vec__21638 = p__21637;
var j = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21638,(0),null);
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21638,(1),null);
var a = ((j * cols) + i);
var b = (a + (1));
var c = (a + cols);
var d = (c + (1));
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,c,b,b,c,d], null);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (){var iter__5480__auto__ = (function kami$sculpt$iter__21641(s__21642){
return (new cljs.core.LazySeq(null,(function (){
var s__21642__$1 = s__21642;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__21642__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var j = cljs.core.first(xs__6385__auto__);
var iterys__5476__auto__ = ((function (s__21642__$1,j,xs__6385__auto__,temp__5825__auto__,positions,cols){
return (function kami$sculpt$iter__21641_$_iter__21643(s__21644){
return (new cljs.core.LazySeq(null,((function (s__21642__$1,j,xs__6385__auto__,temp__5825__auto__,positions,cols){
return (function (){
var s__21644__$1 = s__21644;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__21644__$1);
if(temp__5825__auto____$1){
var s__21644__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__21644__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21644__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21646 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21645 = (0);
while(true){
if((i__21645 < size__5479__auto__)){
var i = cljs.core._nth(c__5478__auto__,i__21645);
cljs.core.chunk_append(b__21646,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,i], null));

var G__21756 = (i__21645 + (1));
i__21645 = G__21756;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21646),kami$sculpt$iter__21641_$_iter__21643(cljs.core.chunk_rest(s__21644__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21646),null);
}
} else {
var i = cljs.core.first(s__21644__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [j,i], null),kami$sculpt$iter__21641_$_iter__21643(cljs.core.rest(s__21644__$2)));
}
} else {
return null;
}
...
});})(s__21642__$1,j,xs__6385__auto__,temp__5825__auto__,positions,cols))
,null,null));
});})(s__21642__$1,j,xs__6385__auto__,temp__5825__auto__,positions,cols))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(slices)));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,kami$sculpt$iter__21641(cljs.core.rest(s__21642__$1)));
} else {
var G__21759 = cljs.core.rest(s__21642__$1);
s__21642__$1 = G__21759;
continue;
}
} else {
return null;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(mesh,new cljs.core.Keyword(null,"masks","masks",416633332),(function (p1__21648_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (v){
return (1.0 - v);
}),(function (){var or__5002__auto__ = p1__21648_SHARP_;
 ...
 */
kami.sculpt.apply_mask_brush = (function kami$sculpt$apply_mask_brush(mesh,p__21650){
var map__21651 = p__21650;
var map__21651__$1 = cljs.core.__destructure_map(map__21651);
var center = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21651__$1,new cljs.core.Keyword("brush","center","brush/center",-586838954));
var radius = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21651__$1,new cljs.core.Keyword("brush","radius","brush/radius",-1965808916));
var strength = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21651__$1,new cljs.core.Keyword("brush","strength","brush/strength",-438330772));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21651__$1,new cljs.core.Keyword("brush","mode","brush/mode",610910645));
 ...
 */
kami.sculpt.apply_mesh_brush = (function kami$sculpt$apply_mesh_brush(mesh,p__21653){
var map__21654 = p__21653;
var map__21654__$1 = cljs.core.__destructure_map(map__21654);
var b = map__21654__$1;
var center = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21654__$1,new cljs.core.Keyword("brush","center","brush/center",-586838954));
var radius = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21654__$1,new cljs.core.Keyword("brush","radius","brush/radius",-1965808916));
var strength = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21654__$1,new cljs.core.Keyword("brush","strength","brush/strength",-438330772));
var mode = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21654__$1,new cljs.core.Keyword("brush","mode","brush/mode",610910645));
if(cljs.core.truth_((function (){var fexpr__21655 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"mask","mask",-585748447),null,new cljs.core.Keyword(null,"mask-erase","mask-erase",-1259279978),null], null), null);
return (fexpr__21655.cljs$core$IFn$_invoke$arity$1 ? fexpr__21655.cljs$core$IFn$_invoke$arity$1(mode) : fexpr__21655.call(null, mode));
})())){
...
return cljs.core.vec(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(brushes,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21658_SHARP_){
return kami.sculpt.mirrored(p1__21658_SHARP_,axis);
}),brushes))));
...
var G__21782 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,next_point);
var G__21783 = remaining;
var G__21784 = next_point;
result = G__21782;
remaining = G__21783;
cursor = G__21784;
continue;
...
var G__21785 = result;
var G__21786 = cljs.core.rest(remaining);
var G__21787 = target;
result = G__21785;
remaining = G__21786;
cursor = G__21787;
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(G__21664,cljs.core.last(points));
} else {
return G__21664;
}
}
...
var indices = cljs.core.vec(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__21668){
...
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21669,(2),null);
var ab = midpoint(a,b);
var bc = midpoint(b,c);
var ca = midpoint(c,a);
...
(kami.sculpt.sculpt_layer.cljs$core$IFn$_invoke$arity$4 = (function (id,name,vertex_count,p__21676){
var map__21677 = p__21676;
var map__21677__$1 = cljs.core.__destructure_map(map__21677);
var opacity = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21677__$1,new cljs.core.Keyword(null,"opacity","opacity",397153780),1.0);
var visible_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21677__$1,new cljs.core.Keyword(null,"visible?","visible?",2129863715),true);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21682_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword("sculpt.layer","id","sculpt.layer/id",-1638147226).cljs$core$IFn$_invoke$arity$1(p1__21682_SHARP_));
...
var len__5726__auto___21806 = arguments.length;
var i__5727__auto___21807 = (0);
while(true){
if((i__5727__auto___21807 < len__5726__auto___21806)){
args__5732__auto__.push((arguments[i__5727__auto___21807]));

var G__21808 = (i__5727__auto___21807 + (1));
i__5727__auto___21807 = G__21808;
continue;
} else {
}
break;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(doc,new cljs.core.Keyword("sculpt","layers","sculpt/layers",568801059),(function (p1__21685_SHARP_){
...
/** @this {Function} */
(kami.sculpt.update_layer.cljs$lang$applyTo = (function (seq21686){
...
var G__21689 = cljs.core.first(seq21686__$2);
var seq21686__$3 = cljs.core.next(seq21686__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21687,G__21688,G__21689,seq21686__$3);
}));
...
var layers = cljs.core.vec(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__21694_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(id,new cljs.core.Keyword("sculpt.layer","id","sculpt.layer/id",-1638147226).cljs$core$IFn$_invoke$arity$1(p1__21694_SHARP_));
}),new cljs.core.Keyword("sculpt","layers","sculpt/layers",568801059).cljs$core$IFn$_invoke$arity$1(doc)));
...
if(cljs.core.truth_((function (){var G__21699 = new cljs.core.Keyword("brush","mode","brush/mode",610910645).cljs$core$IFn$_invoke$arity$1(b);
var fexpr__21698 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"mask","mask",-585748447),null,new cljs.core.Keyword(null,"mask-erase","mask-erase",-1259279978),null], null), null);
...
return kami.sculpt.update_layer.cljs$core$IFn$_invoke$arity$variadic(doc,active,cljs.core.update,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword("sculpt.layer","deltas","sculpt.layer/deltas",818949036),(function (p1__21697_SHARP_){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$3(kami.sculpt.add,p1__21697_SHARP_,increment);
})], 0));
}
});
/**
