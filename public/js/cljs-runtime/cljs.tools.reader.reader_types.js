...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21649 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21649(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21652 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21652(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21656 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21656(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21659 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21659(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21661 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21661(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21663 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21663(reader);
}
});
...
var G__21721 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__21722 = s.append(c);
c = G__21721;
s = G__21722;
continue;
}
